 ...
 * @version	GENERATED
 */
public abstract class AbstractFlankingBonus implements FlankingBonus {
	...
	public boolean equals(Object otherObject) {
		...
		if (!(otherObject instanceof FlankingBonus)) return false;
		FlankingBonus other = (FlankingBonus) otherObject;
