 ...
 * @version	GENERATED
 */
public abstract class AbstractCommandDescription implements CommandDescription {
	...
	public boolean equals(Object otherObject) {
		...
		if (!(otherObject instanceof CommandDescription)) return false;
		CommandDescription other = (CommandDescription) otherObject;
	...
	public int hashCode() {
		...
		_res += this.getSupportedCommandId() * (int) (10E5);
	...
	public String toString() {
		...
		_res = _res + "supportedCommandId=" + this.getSupportedCommandId() + ", ";
		_res = _res + ")";
