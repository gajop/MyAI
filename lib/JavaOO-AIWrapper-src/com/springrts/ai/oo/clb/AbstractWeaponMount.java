 ...
 * @version	GENERATED
 */
public abstract class AbstractWeaponMount implements WeaponMount {
	...
	public boolean equals(Object otherObject) {
		...
		if (!(otherObject instanceof WeaponMount)) return false;
		WeaponMount other = (WeaponMount) otherObject;
	...
	public int hashCode() {
		...
		_res += this.getWeaponMountId() * (int) (10E5);
	...
	public String toString() {
		...
		_res = _res + "weaponMountId=" + this.getWeaponMountId() + ", ";
		_res = _res + ")";
