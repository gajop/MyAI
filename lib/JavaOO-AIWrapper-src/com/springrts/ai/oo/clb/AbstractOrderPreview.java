 ...
 * @version	GENERATED
 */
public abstract class AbstractOrderPreview implements OrderPreview {
	...
	public boolean equals(Object otherObject) {
		...
		if (!(otherObject instanceof OrderPreview)) return false;
		OrderPreview other = (OrderPreview) otherObject;
