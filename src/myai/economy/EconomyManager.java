...
public class EconomyManager extends Module implements UnitManagerListener {
        ...
        for (Unit gatherer : potentialGatherers) {
            ...
            if (closest != null && closestDistance < MAX_GATHERING_RANGE) {
                ...
                if (ownershipGranted) {
                    ...
                    gatherer.reclaimFeature(closest, MyAI.getOpts(), MyAI.getTimeout());
    ...
    public int commandFinished(Unit unit, int commandId, int commandTopicId) {
    	//63 == reclaim unit, 64 == reclaim area, 82 == reclaim feature
        if (commandTopicId == 63 || commandTopicId == 64 || commandTopicId == 82) {
